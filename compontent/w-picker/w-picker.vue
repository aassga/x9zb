<template name="w-picker">
	<view class="w-picker" :key="createKey" :data-key="createKey">
		...
		<view class="w-picker-cnt" :class="{'visible':visible}">
			<view class="w-picker-title">
				<view class="w-picker-header"  @touchmove.stop.prevent catchtouchmove="true">
					<view @tap.stop.prevent="onCancel">取消</view>
					<view class="w-picker-header-title">
						{{title}}
					</view>
					<view :style="{'color':themeColor}" @tap.stop.prevent="pickerConfirm">确定</view>
				</view>
			</view>
...
<script>
	import dPicker from "./double-picker.vue"
