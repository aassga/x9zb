...
export default {
  ...
  addGroup ({ commit }, params) {
    return HomedApi.addGroup(params).then(res => {
      return res
    })
  },
  delGroup ({ commit }, params) {
    return HomedApi.delGroup(params).then(res => {
      return res
    })
  },
  editGroupName ({ commit }, params) {
    return HomedApi.editGroupName(params).then(res => {
      return res
    })
  },
  uploadGroupPic ({ commit }, params) {
    return HomedApi.uploadGroupPic(params).then(res => {
      return res
    })
  },
  getChatRoomUserList ({ commit }, params) {
    return HomedApi.getChatRoomUserList(params).then(res => {
      return res
    })
  },
  getUserList ({ commit }, params) {
    return HomedApi.getUserList(params).then(res => {
      return res
    })
  },
  getChatRoomUserInfo ({ commit }, params) {
    return HomedApi.getChatRoomUserInfo(params).then(res => {
      return res
    })
  },
  leaveGroup ({ commit }, params) {
    return HomedApi.leaveGroup(params).then(res => {
      return res
    })
  },
  getUserTag ({ commit }, params) {
    return HomedApi.getUserTag(params).then(res => {
      return res
    })
  },
  addTag ({ commit }, params) {
    return HomedApi.addTag(params).then(res => {
      return res
    })
  },
  deleteTag ({ commit }, params) {
    return HomedApi.deleteTag(params).then(res => {
      return res
    })
  },
  ...
  clearHistory ({ commit }, params) {
    return HomedApi.clearHistory(params).then(res => {
      return res
    })
  },

  updateUser ({ commit }, params) {
    return HomedApi.updateUser(params).then(res => {
      return res
    })
  },
  ...
  getAllChannel ({ commit }) {
    return HomedApi.getAllChannel().then(res => {
      return res
    })
  },
  getAllMessageList ({ commit }) {
    return HomedApi.getAllMessageList().then(res => {
      return res
    })
  },
  deleteMessageList ({ commit }, params) {
    return HomedApi.deleteMessageList(params).then(res => {
      return res
    })
  },
  editMessageList ({ commit }, params) {
    return HomedApi.editMessageList(params).then(res => {
      return res
    })
  },
  addMessageList ({ commit }, params) {
    return HomedApi.addMessageList(params).then(res => {
      return res
    })
  },
  getEnterHallList ({ commit }, params) {
    return HomedApi.getEnterHallList(params).then(res => {
      return res
    })
  }
}
