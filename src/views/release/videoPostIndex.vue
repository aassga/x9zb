      ...
      <div class="release-container">
        ...
        <div  class="prviewImgBox">
          <div v-if="videoUrl" class="video-box">
            <video :src="videoUrl" playsinline="true" width="100%" height="auto" controls="true" x5-video-player-type="h5-page"></video>
            <div class="close" @click="deletVideo()">X</div>
          </div>
          <div v-if="imgUrl.length > 0" class="totalImgBox">
...
import videoStickerAnimate from './videoStickerAnimate.vue'
...
export default {
  ...
  computed: {
    ...
    videoUrl () {
      ...
      if (videoData.length > 0) {
        url = URL.createObjectURL(videoData[0])
      }
      return url
    }
  },
  ...
  methods: {
    ...
    SetStickerAnimate (value) {
      ...
      setTimeout(() => {
        this.$refs.animatiBox.$refs.videoPost.$refs.post.getPhoto(this.imgData)
        this.$refs.animatiBox.$refs.videoPost.$refs.video.addList(this.videoData)
      }, 1000)
    },
    // 打开图文发帖按钮
    openPostBox () {
