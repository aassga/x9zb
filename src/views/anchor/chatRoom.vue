    ...
    <div class="anchor-live-chatroom">
                ...
                <div class="second-rank">
                  <div class="layout-user" v-if="paiList[1]">
                    <div class="second-b Crown">
                      <div
                        class="rank-mark-s rank-mark-s2 Crown"
                        style="color: rgb(255, 255, 255)"
                      ></div>
                      <div class="lazyload-wrapper">
                        <img
                          class="avatar"
                          :src="paiList[1].avatar"
                          width="136"
                          height="136"
                        />
                      </div>
                      <div class="contribute-value1">
                        {{ paiList[1].amount }}
                      </div>
                    </div>
                    <div class="name third-t">
                      {{ paiList[1].user_nickname }}
                    </div>
                    <div class="level-wrap">
                      <img
                        class="level-left"
                        v-if="paiList[1].is_guard == 1"
                        :src="paiList[1].guard.icon"
                      />
                      <img
                        class="level-right"
                        v-if="paiList[1].exp"
                        :src="paiList[1].exp.thumb"
                      />
                    </div>
                  </div>
                </div>
                ...
                <div class="first-rank">
                  <div class="layout-user" v-if="paiList[0]">
                    <div class="Crown first-b">
                      <div
                        class="rank-mark-s rank-mark-s1 Crown"
                        style="color: rgb(255, 255, 255)"
                      ></div>
                      <div class="lazyload-wrapper">
                        <img
                          class="avatar"
                          :src="paiList[0].avatar"
                          width="136"
                          height="136"
                        />
                      </div>
                    ...
                    <div class="name first-t">
                      {{ paiList[0].user_nickname }}
                    </div>
                    <div class="level-wrap">
                      <img
                        class="level-left"
                        v-if="paiList[0].is_guard == 1"
                        :src="paiList[0].guard.icon"
                      />
                      <img
                        class="level-right"
                        v-if="paiList[0].exp"
                        :src="paiList[0].exp.thumb"
                      />
                    </div>
                  </div>
                </div>
                ...
                <div class="third-rank">
                  <div class="layout-user" v-if="paiList[2]">
                    <div class="Crown third-b">
                      <div
                        class="rank-mark-s rank-mark-s3 Crown"
                        style="color: rgb(255, 255, 255)"
                      ></div>
                      <div class="lazyload-wrapper">
                        <img
                          class="avatar"
                          :src="paiList[2].avatar"
                          width="136"
                          height="136"
                        />
                      </div>
                    ...
                    <div class="name third-t">
                      {{ paiList[2].user_nickname }}
                    </div>
                    <div class="level-wrap">
                      <img
                        class="level-left"
                        v-if="paiList[2].is_guard == 1"
                        :src="paiList[2].guard.icon"
                      />
                      <img
                        class="level-right"
                        v-if="paiList[2].exp"
                        :src="paiList[2].exp.thumb"
                      />
                    </div>
                  </div>
                </div>
                ...
                <ul class="other-rank">
                  ...
                  >
                    <div class="left-wrap">
                      ...
                      <span class="name-rank color-7770b6">{{
                        item.user_nickname
                      }}</span>
                    </div>
                    <span class="val-rank">
      ...
      <div id="chat-notification">
        <div>
          <div
            ...
            style="right: 0px; top: 0px; bottom: auto"
          >
            <div></div>
          </div>
        </div>
      ...
      <div class="chat-content">
        ...
        <div class="gitf-list">
          ...
          <div
            class="gitf-mask"
            v-for="(item1, index) in gitfList"
            :key="index"
            :style="{
              background: 'linear-gradient(to right,' + colorList[0].rgb + ')',
            }"
          >
        ...
        <div
          class="gitf-big-mask"
          v-show="gitfBigMask && checkList.indexOf('2') == -1"
          id="gitfBigMask"
        ></div>
        ...
        <div class="gitf-big-mask" style="width: 100%; top: 0px">
          ...
          <div
            class=""
            style="width: 100%; height: 175.91px"
            v-for="(item, index) in gitfListSvg"
            :key="index"
          >
            <div
              class=""
              style="height: 175.91px; position: relative"
              :id="'svgaAnimation' + item.gitfNum"
            >
              <p class="svgaAnimation-li">
                <span class="svgaAnimation-text">{{ item.nick }}</span
                >骑着{{ item.guard_name }}驾临
              </p>
            </div>
        ...
        <div class="message-list" ref="messageContent">
          <div class="chatroom-message-item-box">
            <div
              class="
                message-content message-content-noble-undefined
                message-content--1
              "
            >
              <span> </span>
              <span
                class="message-text message-text-type--1 message-text-noble-0"
          ...
          <!-- 判断自己是否房主  -->
          <div
            class="chatroom-message-item-box"
            v-for="(item, index) in list"
            :key="index"
            @click="infos.id == roomid ? setHuoserMask(item) : ''"
          >
            <!-- {{colorList[0]}} -->
            <!-- 送礼物 -->
            <div
              class="
                message-content message-content-noble-0 message-content-8
                xx
              "
            ...
            >
              <span style="display: inline-flex; transform: translateY(5px)">
                ...
                <img
                  ...
                  v-if="
                    item.data.gift &&
                    item.data.gift.is_guard == 1 &&
                    item.data.gift.is_room == 0
                  "
                  :src="item.data.gift.guard_icon"
                  alt=""
                />
                <div
                  class="vip"
                  style="line-height: 20px; color: white; text-indent: 29px"
                  v-if="item.data.gift"
                  :style="{
                    background:
                      'url(' +
                      item.data.gift.exp_icon +
              ...
              ><span
                class="message-text message-text-type-8 message-text-noble-0"
                ><span
                  ><span style="color: #111">送给主播</span
                  ><span style="color: #fe9100 !important; margin-left: 4px"
                    >{{ item.data.gift.giftname }}x1</span
                  >
                </span></span
              >
            </div>
            ...
            <div
              class="
                message-content message-content-noble- message-content-0
                xx
              "
            ...
            >
              <span style="display: inline-flex; transform: translateY(5px)">
                ...
                <img
                  ...
                  v-if="
                    item.data.normal &&
                    item.data.normal.is_guard == 1 &&
                    item.data.normal.is_room == 0
                  "
                  :src="item.data.normal.guard_icon"
                  alt=""
                />
                <div
                  class="vip"
              ...
              <span
                @click="infos.id == roomid ? setHuoserMask(item) : ''"
                class="message-text message-text-type-0 message-text-noble-"
                style="color: rgb(50, 52, 58)"
              >
                <span
                  v-html="getText(item.data.normal.text)"
                  style="cursor: pointer"
                  @click="showTips(index)"
                >
                </span>
                <span
                  v-if="tipsId == index"
                  @click="copyText(item.data.normal.text)"
                  class="txt-control"
                  >复制<i
                /></span>
              </span>
            ...
            >
              ...
              >
                ...
                <img
                  ...
                  v-if="
                    item.data.color &&
                    item.data.color.is_guard == 1 &&
                    item.data.color.is_room == 0
                  "
                  :src="item.data.color.guard_icon"
                  alt=""
                />
                <div
                  class="vip"
              ...
              >
                <span
                  v-html="getText(item.data.color.text)"
                  @click="showTips(index)"
                ></span>
                <span
                  v-if="tipsId == index"
                  @click="copyText(item.data.color.text)"
                  class="txt-control"
                  >复制<i
                /></span>
              </span>
            ...
            <div
              class="
                message-content
                message-content-noble-undefined
                message-content-1
                message-content-wealth
                flex-start
              "
            ...
            >
              <span style="display: inline-flex; transform: translateY(3px)">
                ...
                <img
                  ...
                  v-if="
                    item.data.nobel &&
                    item.data.nobel.is_guard == 1 &&
                    item.data.nobel.is_room == 0
                  "
                  :src="item.data.nobel.guard_icon"
                  alt=""
                />
                <div
                  class="vip"
      ...
      <div class="footer">
        ...
        <div class="layout-chat-tool">
          <div class="left">
            ...
            >
              <div
                class="tool-icon textStyleIcon"
                :class="iconIndex == 5 ? 'reset-default' : ''"
                @click="setIcon(5)"
              ></div>
            </el-tooltip>
            <!-- 思路：1。如果等于1 赋值null，2.等于null 赋值1，3等于其它赋值1 -->
            <div
              class="tool-icon clearMessage"
              @click="$store.state.messageList = []"
            ></div>
          </div>
          <div class="right"></div>
        </div>
          ...
          <div class="layout-chat-input">
            <div class="message-input">
              ...
              <label
                ...
                v-if="JSON.stringify(infos) == '{}'"
              >
                <div
                  class="unlogin-box"
                  @click="$store.state.user.showLoginMask = true"
                >
                  <span class="login-btn"
                    >登录<span class="login-tab"> </span
                  ></span>
                  <span
                    class="unlogin-box-text"
                    style="color: rgb(201, 202, 218)"
                    >发弹幕,参与互动</span
                  >
                </div>
              </label>
              ...
              <label style="position: relative" v-else>
                <div
                  class="
                    message-input-content message-input-content-with-flaunt
                  "
                  style="height: 94%; line-height: 46px"
                  v-if="barrageIndex != null"
                >
                  <span class="flaunt-input-text" style="line-height: 50px"
                    >炫彩气泡：</span
                  >
                  <input
                    placeholder="我也来说几句…"
                    type="text"
                    v-model="message"
                    class="input-content input_focus"
                    value=""
                ...
                >
                  <input
                    ...
                    :style="{
                      color: iconIndex == 5 ? '' : colorList[colorIndex].color,
                    }"
                    v-model="message"
                    type="text"
                    class="input-content"
            ...
            <div
              class="send-btn"
              :class="message.length == 0 ? 'send-disabled' : 'active'"
              @click="sendMessage()"
            >
              发送
            </div>
                ...
                <el-popover placement="top" width="300" trigger="click">
                  <ul class="emoji-mart-category-list">
                    <li
                      ...
                      :key="index"
                      @click="setEmotion(item.emojiName)"
                    >
                      <img
      ...
      <div class="user-operation-modal-wrap" v-if="houseMask">
        <div class="user-operation-box" style="height: 200px">
          <img
          ...
          <div class="operation-footer">
            <div class="operation-footer-anthor">
              <button
                class="i-button i-danger-image-button button-danger"
                @click="forbid(HuoserItem, 1)"
              >
                禁发言
              </button>
              <button
                class="i-button i-default-button button-fangguan"
                @click="forbid(HuoserItem, 2)"
              >
                解除禁言
              </button>
            </div>
      ...
      <div class="horn-modal" v-if="iconIndex == 4">
        <div class="horn-modal-title">
          ...
          ><img
            ...
            @click="iconIndex = null"
            width="12px"
            alt=""
          />
        </div>
        <div class="horn-modal-body">
          <div class="horn-modal-text">
            <span
              >全局喇叭剩余: <span class="horn-num">0</span> 个,<span
                class="horn-owner"
                >皇帝</span
              >可获得喇叭</span
            ><a class="horn-view" @click="setIcon(2)">查看喇叭</a>
          </div>
          <div class="horn-modal-info">
            <img
              class="horn-info-icon"
            ...
            /><textarea
              v-model="text"
              maxlength="20"
              placeholder="请输入,弹幕内容全局可见"
              rows="2"
              class="horn-modal-input"
            ></textarea
            ><span class="horn-input-num">{{ text.length || 0 }}</span
            ><span class="horn-input-num-total">/20</span
            ><button class="horn-modal-sendBtn" @click="sneHorn()">发送</button>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="chatroom-grades" style="border-radius: 20px">
        ...
        >
          ...
          <div class="flex imgNavBox">
            <div
              class="imgNav flex-center"
              :class="index == nobilityIndex ? 'nobilityActive' : 'nobility'"
              @click="nobilityIndex = index"
              v-for="(item, index) in goard"
              :key="index"
            >
          ...
          <div id="gradesCont">
            ...
            <div class="gradesContRight">
              <div>
                <img class="img2" :src="goard[nobilityIndex].icon" />
              ...
              <div>
                ...
                <div class="gcrc1">
                  尊享{{ nobilityIndex + 1 }}级气泡{{
                    goard[nobilityIndex].gorgeous_num
                  }}个
                </div>
                <div class="gcrc2">解锁1～5级粉丝弹幕</div>
                <div class="gcrcl">
                  <div
                    v-for="(item, index) in colorL"
                    :key="index"
                    v-if="index < nobilityIndex + 1"
          ...
          <div id="gradesBot">
            <div class="gradesBotLeft">
              <div class="line1-box">
                <span
                  >开通{{ goard[nobilityIndex].name }}：<span
                    class="gradesBotText"
                    >{{ goard[nobilityIndex].coin }}</span
                  >龙钻/月</span
                ><span style="margin-left: 12px"
                  >续费{{ goard[nobilityIndex].name }}：<span
                    class="gradesBotText"
                    >{{ goard[nobilityIndex].renew_coin }}</span
                  >龙钻/月</span
                >
              </div>
              <div class="line2-box">
            ...
            <div
              class="line3-box"
              style="color: #aaa"
              v-if="infos.is_guard == 1"
            >
              <p>
                您已开通<span class="gradesBotText">
                  {{ infos.guard.name }}
                </span>
              </p>
              <p>
                到期时间：<span class="gradesBotText"
                  >{{ $common.timeStamp1(infos.guard.endtime) }}
                </span>
              </p>
            </div>
            <div class="gradesBotRight" @click="showBtn = true">
              {{
                infos.is_guard == 1 &&
                goard[nobilityIndex].name == infos.guard.name
                  ? "立即续费"
                  : "立即开通"
              }}
            </div>
          ...
          <div id="showBtn" v-if="showBtn">
            <div class="showBtn">
              ...
              <div class="btnContent">
                ...
                <div
                  class="btnSure"
                  @click="guardUserBuy(goard[nobilityIndex])"
                >
                  确定
                </div>
              </div>
...
export default {
  ...
  watch: {
    "$store.state.item"(e) {
      ...
      if (
        gitfItem.type == "TIMCustomElem" &&
        gitfItem.data.type == 102 &&
        gitfItem.data.nobel.is_guard == 1
      ) {
        //贵族进入直播间
  ...
  methods: {
      ...
      getGuardList()
        .then((res) => {
          ...
          _this.colorList.forEach((item) => {
            item.rgb =
              item.color + "FF," + item.color + "ED," + item.color + "00";
          });
        })
        .catch((res) => {});
    },
    ...
    getGitfList(gitfItem) {
      ...
      if (
        endObj &&
        endObj.value === gitfItem.data.gift.giftname &&
        !endObj.timeOut
      ) {
        this.gitfList.pop();
      ...
      if (data.type == 100) {
        ...
        msg = {
          ...
          normal: {
            ...
            xcBarrageUrl:
              this.barrageIndex != null
                ? this.barragelist[this.barrageIndex].gifticon
                : "", //气泡的图片路径
            xcBarrageType:
              this.barrageIndex != null
                ? this.barragelist[this.barrageIndex].list_order
                : "", //图片路径
            text: this.message,
            exp_icon: this.infos.exp_icon,
            is_guard: this.infos.is_guard,
...
.chatroom-grades .grades {
  background: url(../../assets/images/gui-bg.png) center top / 100% 100%
    no-repeat;
}
...
.nobility {
  background: url(../../assets/images/gui-down.png) center top / 100% 100%
    no-repeat;
}

.nobilityActive {
  /* background: url(../../assets/images/gui-down.png)center top / 100% 100% no-repeat; */
  background: url(../../assets/images/gui-up.png) center top / 100% 100%
    no-repeat;
}
