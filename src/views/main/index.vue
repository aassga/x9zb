    ...
    <div class="home-page">
          ...
          <div class="anchor-home-page-top-container">
            ...
            <div class="counttDownShow" v-if="counttDown">
              <div class="center_date">
                ...
                <div class="date_tile">
                  <span class="d_date_d">天</span
                  ><span class="h_date_h">小时</span
                  ><span class="m_date_m">分钟</span
                  ><span class="s_date_s">秒</span>
                </div>
            ...
            <div
              class="anchor-home-page-top-choose-area"
              style="margin-left: 10px"
            >
              <div
                class="anchor-home-page-top-choose-item"
                :class="mainTabIndex == index ? 'choose' : ''"
                @click="mainTabIndex = index"
              ...
              >
                ...
                <div class="lazyload-wrapper" style="height: 100%">
                  <img :src="item.thumb" width="320" height="172" />
                </div>
              </div>
            </div>
          </div>
          <a href="" class="anchor-home-page-top-right-img" target="_blank"></a>
        </div>
      </div>
      ...
      <div class="home-page-main">
        <div v-if="false" class="live-match-grid" style="width: auto">
                  ...
                  <div class="match-card">
                    <div>
                      <div
                        ...
                        :style="
                          item.anchor.length === 0 ? 'padding-right:10px' : ''
                        "
                      >
                        ...
                        <div class="match-card-header-icons">
                          <div
                            class="match-card-reservation"
                            v-if="item.status_id == 1 && item.reserve == 0"
                            @click="getReserveMatch(item)"
                            :style="
                              item.anchor.length !== 0 ? 'margin-right:5px' : ''
                            "
                          ></div>
                          <div
                            class="match-card-reservation-already"
                            v-if="item.reserve != 0"
                          ></div>

                          <div
                            class="match-card-header-img flex-start"
                            v-if="item.anchor.length !== 0"
                          >
                    ...
                    <div class="match-card-content">
                      ...
                      <div class="match-card-content-row">
                        ...
                        <div class="team-name-1 ellipsis">
                          {{ item.home_team_name }}
                        </div>
          ...
          <aside
            class="live-match-grid-prev live-match-grid-aside"
            @click="prev()"
          ></aside>
          <aside
            class="live-match-grid-next live-match-grid-aside"
            @click="next()"
          ></aside>
          <div
            class="live-match-grid-saicheng"
            style="width: 90px"
            @click="navigate('schedule', 3)"
          >
          ...
          <div class="grid-header">
            <div class="grid-header-left">
              <img
                ...
                src="../../assets/images/main-hot-titme.png"
                alt=""
              />
          ...
          <div 
            ...
            >
              <div
                ...
                :style="{
                  background:
                    ' url(' + item.thumb + ')center top / cover no-repeat',
                }"
              >
                    ...
                    <div class="anchor-info-title ellipsis" title="">
                      {{
                        item.title.split(" ").length === 2
                          ? item.title
                              .split(" ")
                              .slice(1, item.title.split(" ").length)
                              .join()
                          : item.title
                      }}
                    </div>
          ...
          <div>
            <div class="grid-header">
              <div class="grid-header-left">
                <img
                  class="grid-header-left-icon"
                  src="../../assets/images/main-sport-title.png"
                  alt=""
                />
                <div class="grid-header-left-text">体育头条</div>
                <div class="grid-header-left-nav">
                  <div
                    :class="classificationIndex == index ? 'active2' : ''"
                    @click="classificationIndex = index"
              ...
              <div class="grid-header-right">
                <a class="grid-header-right-more" href="/news?activeId=9999"
                  >更多 <i></i
                ></a>
              </div>
            </div>
            <div class="home-news-body">
              <div class="news-carousel">
                ...
                >
                  <el-carousel-item
                    v-for="(item, index) in Headlinesbanner"
                    :key="index"
                  >
                    <router-link
                      style="height: 324px; width: 100%"
                      class="headlines-item"
                      tag="a"
                      target="_blank"
              ...
              <div class="headlines-group">
                <div class="headlines">
                  <router-link
                    v-show="index < 11"
                    :class="classificationIndex == 0 ? 'headlines-hot' : ''"
                    v-for="(item, index) in HeadlinesList.data"
                    :key="index"
                    class="headlines-item"
                    tag="a"
                    target="_blank"
          ...
          <div style="height: 100%; overflow: hidden">
            <div class="grid-header">
              <div class="grid-header-left">
                <img
                  class="grid-header-left-icon"
                  src="../../assets/images/main-star.png"
                  alt=""
                />
            ...
            <div class="rank-content">
              <div
                class="rank-content-info"
                style="padding: 0 18px; height: 330px"
              >
                    ...
                    <div class="left">
                      <div class="img" style="position: relative">
                        ...
                        <img
                          class="live"
                          v-if="item.is_live == 1"
                          src="../../assets/images/main-hot-live.png"
                        />
                      </div>
                      <div class="level-logo" style="margin: 0 10px">
        ...
        <div class="official-activity">
          <div class="title">
            <div class="title-left">
              <img
                class="icon"
                src="../../assets/images/main-hot-title.png"
                alt=""
              /><span>官方活动</span>
            </div>
...
import { getAllMatch } from "../../api/user.js";
import { recommend } from "../../api/common.js";
import {
  season_table,
  getLiveList,
  reserveMatch2,
  ...
  methods: {
    ...
    next() {
      if (this.num > -(this.list.length + this.num)) {
        ...
        this.num < -(this.list.length + this.num) &&
        -(this.list.length + this.num) != -0
      ) {
        this.num -= 1;
      }
    },
...
.anchor-rank-content-list
  ...
  .living_box
  .strip:first-child {
  animation: surfa 0.7s linear 0.3s infinite;
}
