<template>
	<div>
		<section class="container-section border-top-radius-none" id="finished" v-infinite-scroll="load" style="
        margin-bottom: 10px;
      ...
      ">
			<ul>
				...
				<!-- <img src="../../assets/images/qsy.png" v-if="loadStatus == 'noMore'" style="
            width: 237px;
            height: 156px;
            margin: 100px auto;
            display: block;
		...
		methods: {
			...
			getlist() {
				let data = {
					...
					isWeb:1,
					// page: this.page,
					time: this.time.day || new Date().toISOString().slice(0, 10),
				};
				getList(data)
					.then((res) => {
